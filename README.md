...
- [ArchR](https://github.com/GreenleafLab/ArchR) - R package for processing and analyzing single-cell ATAC-seq data. [GitHub repo](https://github.com/GreenleafLab/ArchR)
